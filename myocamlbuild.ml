(* OASIS_START *)
(* DO NOT EDIT (digest: ddbb60252df2b34aa75c45e5b28ecdf5) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("minisat", ["src"], [])];
     lib_c = [("minisat", "src", ["src/vec.h"; "src/solver.h"])];
     flags =
       [
          (["oasis_library_minisat_ccopt"; "compile"],
            [
